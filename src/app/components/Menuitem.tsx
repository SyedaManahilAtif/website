    ...
    return (
        <div className="relative min-h-screen py-6">
            <div
                ...
                style={{
                    backgroundImage:
                        "url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSoQekaVmbn9Jh2F3gbZ9cIodYb3_PS58O1awWxmffgIJPkaB2fHHfr4LhUw4CuhSvtKbs&usqp=CAU')"
                }}
            ></div>
            <div className="relative z-10">
                <div className="max-w-6xl mx-auto text-center mb-8">
                    ...
                    <p className="text-xl text-white">
                        Explore Our Section Of Mouth Watering Burgers. Fresh
                        ingredients, tasty flavors, and the best experience!
                    </p>
                </div>
                                    ...
                                    <div className="flex justify-between items-center mt-6 text-black">
                                        ...
                                        <div>
                                            <button
                                                ...
                                                className="bg-green-600 py-3 px-8 rounded-lg text-lg shadow-md hover:green-700 transition duration-300 ease-in-out text-white transform hover:scale-110"
                                            >
                                                Proceed To Checkout
                                            </button>
                                            ...
                                            <button
                                                onClick={clearCart}
                                                className="bg-red-600 py-3 px-8 rounded-lg ml-4 text-lg shadow-md hover:red-700 transition duration-300 ease-in-out text-white transform hover:scale-110"
                                            >
                                                Clear Cart
                                            </button>
                                        </div>
                        ...
                        <div className="bg-white p-8 rounded-lg shadow-lg w-full sm:w-96">
                            ...
                            <div className="mt-6 flex justify-between">
                                ...
                                <button
                                    onClick={() =>
                                        alert(
                                            "Order Confirm .. Will Deliver At Your Door Step In 2 Days"
                                        )
                                    }
